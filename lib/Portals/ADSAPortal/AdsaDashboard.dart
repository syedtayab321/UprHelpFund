...
class ADSADashboardPage extends StatelessWidget {
  final AdsaBottomBarController _controller = Get.put(AdsaBottomBarController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextWidget(title: 'ADSA Portal',color: Colors.white,),
        backgroundColor: Colors.teal.shade700,
        actions: [
          Icon_Button(onPressed: (){}, icon: Icon(Icons.logout_outlined),color: Colors.white,)
        ],
      ),
      body: Obx(() {
